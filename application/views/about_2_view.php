...
<section class="page-title" style="background-image:url(<?php echo site_url('assets/public/img/background/store_2/about.jpg')?>);">
...
<section class="carousel-section">
    <div class="auto-container">
        <div class="single-item-carousel owl-theme owl-carousel">
			<div class="slide"> <img src="<?php echo site_url('assets/public/img/background/store_2/about_slide_1.jpg')?>" alt="" /> </div>
			<div class="slide"> <img src="<?php echo site_url('assets/public/img/background/store_2/about_slide_2.jpg')?>" alt="" /> </div>
			<div class="slide"> <img src="<?php echo site_url('assets/public/img/background/store_2/about_slide_3.jpg')?>" alt="" /> </div>
        </div>
    </div>
    <br>
    <br>
...
-->
<section class="place-section" style="background-image:url('<?php echo site_url('assets/public/img/background/store_2/about_break.jpg')?>');">
    <div class="auto-container">
        <div class="row clearfix">
