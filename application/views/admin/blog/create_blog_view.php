            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_input('title_en', set_value('title_en'), 'class="form-control" id="title-en"');
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_input('title_hu', set_value('title_hu'), 'class="form-control" id="title-hu"');
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                    ...
                    <div class="form-group description">
                        <?php
                        echo form_label('Leírás', 'description_hu');
                        echo form_error('description_hu');
                        echo form_textarea('description_hu', set_value('description_hu'), 'class="form-control"');
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                        ...
                        echo form_textarea('content_hu', set_value('content_hu', '', false), 'class="form-control blog-content"')
                        ?>
                    </div>
                </div>
